...
kable(caption = "Statistics summary of vaccination data", 
  ...
  scroll_box(width = "100%", height = "300px")
```
Same as before, Austria was filtered out from the list, and location and iso_code(country code) were removed as we only focuses on this country. The <mark>clean vaccination data</mark> is shown as follow.
